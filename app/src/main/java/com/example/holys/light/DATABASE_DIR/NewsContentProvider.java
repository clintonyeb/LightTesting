...
public class NewsContentProvider extends ContentProvider {
    ...
    public int delete (Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriType) {
            case NewsContract.WORLD:
                rowsDeleted = db.delete(NewsContract.DataContract.WORLD_TABLE_NAME, selection, selectionArgs);
                break;
            case NewsContract.WORLD_ID:
                ...
                break;
            case NewsContract.SCIENCE:
                rowsDeleted = db.delete(NewsContract.DataContract.SCIENCE_TABLE_NAME, selection, selectionArgs);
                break;
            case NewsContract.SCIENCE_ID:
                id = uri.getLastPathSegment();
                if (TextUtils.isEmpty(selection)) {
                ...
                break;
            case NewsContract.SPORT:
                rowsDeleted = db.delete(NewsContract.DataContract.SPORT_TABLE_NAME, selection, selectionArgs);
                break;
            case NewsContract.SPORT_ID:
                id = uri.getLastPathSegment();
                if (TextUtils.isEmpty(selection)) {
                ...
                break;
            case NewsContract.CULTURE:
                rowsDeleted = db.delete(NewsContract.DataContract.CULTURE_TABLE_NAME, selection, selectionArgs);
                break;
            case NewsContract.CULTURE_ID:
                id = uri.getLastPathSegment();
                if (TextUtils.isEmpty(selection)) {
                ...
                break;
            case NewsContract.LIFESTYLE:
                rowsDeleted = db.delete(NewsContract.DataContract.LIFESTYLE_TABLE_NAME, selection, selectionArgs);
                break;
            case NewsContract.LIFESTYLE_ID:
                id = uri.getLastPathSegment();
                if (TextUtils.isEmpty(selection)) {
