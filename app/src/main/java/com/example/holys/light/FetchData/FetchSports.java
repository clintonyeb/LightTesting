...
public class FetchSports extends AsyncTask<SportFrag, Void, Void> {
    ...
    @Override
    protected Void doInBackground (SportFrag... params) {
    ...
    {
        _fragment.mResolver.delete(NewsContract.CONTENT_URI_SPORT, null, null);
    }
    ...
    private void InsertIntoTable(List<NewsFacade> data) {
        for (NewsFacade facade :
            ...
            _fragment.mResolver.insert(NewsContract.CONTENT_URI_SPORT, values);
        }
    }
}
