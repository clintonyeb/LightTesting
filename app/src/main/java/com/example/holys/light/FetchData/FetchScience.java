 ...
 */
public class FetchScience extends AsyncTask<ScienceFrag, Void, Void>
{
    ScienceFrag _fragment;

    @Override
    protected Void doInBackground (ScienceFrag... params) {
    ...
    {
        _fragment.mResolver.delete(NewsContract.CONTENT_URI_SCIENCE, null, null);
    }
    ...
    private void InsertIntoTable(List<NewsFacade> data) {
        for (NewsFacade facade :
            ...
            _fragment.mResolver.insert(NewsContract.CONTENT_URI_SCIENCE, values);
        }
    }
}
